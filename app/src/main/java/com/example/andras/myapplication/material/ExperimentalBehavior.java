...
/**
 * Created by Andras_Nemeth on 2016. 06. 27..
 */
public class ExperimentalBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {

    public ExperimentalBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
